...
function StarDivider() {
  return (
    <div className="flex items-center gap-3 justify-center my-2">
      <div className="h-px w-16 bg-seratif-300" />
...
export default function Landing() {
  return (
    <div className="min-h-screen bg-[#f8fafc]">
      ...
      <section className="relative hero-gradient min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:pt-24 sm:pb-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center animate-fade-in-up animate-delay-400">
            <Link to="/register"
              className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-white text-seratif-800 font-semibold rounded-lg sm:rounded-xl hover:bg-seratif-50 transition-all duration-200 active:scale-95 text-sm shadow-lg shadow-black/20">
              Daftar Sekarang
            ...
            <a href="#about"
              className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 border-2 border-white/30 text-white font-medium rounded-lg sm:rounded-xl hover:bg-white/10 transition-all duration-200 active:scale-95 text-sm">
              Pelajari Lebih Lanjut
            </a>
          </div>

          {/* Event quick facts */}
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 max-w-2xl mx-auto mt-10 sm:mt-16 animate-fade-in-up animate-delay-500">
            {[
              { label: 'Pembicara',  value: '2' },
              { label: 'Sesi',       value: '2' },
            ].map(f => (
              <div key={f.label} className="w-full sm:w-auto bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl py-4 sm:py-5 px-4 sm:px-6 border border-white/15">
      ...
      <section id="about" className="py-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="font-display text-4xl font-bold text-seratif-900 mt-2 mb-6 leading-tight">
            ...
            <div className="flex gap-3">
              ...
              <a href="#speakers" className="btn-secondary">Lihat Pembicara</a>
            </div>
          </div>
          <div className="relative">
            <div className="bg-seratif-800 geometric-bg rounded-3xl p-10 text-center">

              <p className="text-seratif-200 text-lg font-light italic leading-loose">
      ...
      {/* ── SPEAKERS ─────────────────────────────────────────────────────── */}
      <section id="speakers" className="py-20 px-6 bg-seratif-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <span className="text-seratif-600 text-xs font-semibold tracking-widest uppercase">Pembicara</span>
            <h2 className="font-display text-4xl font-bold text-seratif-900 mt-2">Speaker Highlights</h2>
            <StarDivider />
          </div>
          <div className="flex justify-center">
            <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl">
              {speakers.map((s) => (
                <div key={s.name} className="card hover:shadow-md hover:-translate-y-1 transition-all duration-300 text-center">
                  <img 
                    src={s.image} 
                    alt={s.name}
                    className="w-40 h-40 rounded-full mx-auto mb-4 object-cover border-4 border-seratif-100 shadow-md"
                  />
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="font-display text-4xl font-bold text-seratif-900 mt-2">Tanggal & Lokasi</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="card flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-seratif-100 flex items-center justify-center shrink-0">
                <svg className="w-6 h-6 text-seratif-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              </div>
              <div>
                <div className="text-xs font-semibold text-seratif-600 uppercase tracking-wide">Tanggal</div>
                <div className="font-display text-xl font-semibold text-seratif-900 mt-1">Sabtu, 7 Maret 2026</div>
            ...
            <div className="card flex items-start gap-4">
              ...
              <div>
                ...
                <div className="font-display text-xl font-semibold text-seratif-900 mt-1">SMKIT Ihsanul Fikri</div>
                <div className="text-slate-500 text-sm mt-1">Jl. Blabak - Mendut, Mertan, Paremono, Kec. Mungkid, Kabupaten Magelang, Jawa Tengah 56512</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ── TICKETS ──────────────────────────────────────────────────────── */}
      <section id="tickets" className="py-20 px-6 bg-seratif-900 geometric-bg">
        <div className="max-w-4xl mx-auto text-center">
          <span className="text-sky-accent text-xs font-semibold tracking-widest uppercase">Tiket</span>
          <h2 className="font-display text-4xl font-bold text-white mt-2 mb-4">Informasi Tiket</h2>
          <p className="text-seratif-300 mb-10 max-w-xl mx-auto">
          ...
          <div className="bg-white rounded-3xl p-8 max-w-md mx-auto shadow-2xl shadow-black/30">
            <div className="text-xs font-semibold text-seratif-600 uppercase tracking-widest mb-2">Tiket Early Bird</div>
            <div className="font-display text-5xl font-bold text-seratif-900 mb-1">Rp 12.000</div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="font-display text-4xl font-bold text-seratif-900 mt-2">Event Moments</h2>
            <StarDivider />
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 md:row-span-2 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
              <img 
            ...
            <div className="md:col-span-3 grid sm:grid-cols-1 md:grid-cols-3 gap-6">
              <div className="rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 h-48">
                <img 
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-display text-4xl font-bold text-seratif-900 mb-4">
            Siap Bergabung?
          </h2>
      ...
      {/* ── FOOTER ───────────────────────────────────────────────────────── */}
      <footer className="bg-seratif-950 text-seratif-400 text-center py-8 px-6">
        <div className="font-display font-semibold text-white mb-2">SERATIF 2026</div>
